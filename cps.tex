...
\begin{document}
    ...
    \begin{abstract}
        \section*{Kurzfassung}
        Durch die enge Koppelung von physischen und Cybersystem bei \cps ergeben sich neue relevante Eigenschaften, welche eine Erweiterung der Eigenschaften von klassischen Systemen darstellen.
    ...
    \subsubsection{Organisatorische Maßnahmen}\label{subsec:physisch}
    % (Cardenas)
    % Transdiszipliär (Brazell14)
    % Betriebsblindheit (Gollman)
    Zugriff auf \cps kann für unautorisierte Personen organisatorisch verhindert werden.
    ...
    \section{Verbesserung der aktuellen Sicherheitssituation von \glsentryshort{cps}}\label{sec:diskussion}
