...
\section{Bedeutung von Security in \glsentrytext{cps}}\label{sec:bedeutung-security}

% Clickbait bei New im Bereich Security

\subsection{Security Definition f\"ur \glsentrytext{cps}}\label{subsec:definition}
% Definition (BG11)
...
\subsubsection{\glsentrytext{cps} als Angriffsziel}\label{subsec:angriffsziel}
% (Gollman, 1)
