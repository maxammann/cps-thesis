...
\begin{document}
    ...
    \subsection{Angriff auf das physischen Systems}\label{subsec:physical-deception}
    Angriffe auf den physischen Teil eines \cps zielen darauf ab Daten, schon vor dem Senden an das Cybersystem zu manipulieren.
