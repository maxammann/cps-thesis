...
Da effiziente Lösungen aufgrund von begrenzten Ressourcen in Autos wichtig sind, schlagen \citeauthor{WG12,HUM 41}\todo{check cite} die Verwendung von Hardware-basierten Lösungen, wie etwa Hardware Security Module, vor.
