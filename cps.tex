...
Deshalb kann man in Fällen, in denen diese nicht erreichbar ist, zunächst auf Plausibility setzen.
...
Es sind weitere Prinzipien nötig um die erweiterten Eigenschaften von \glpl{cps} abzudecken.
