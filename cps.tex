...
Hierbei darf es nicht möglich sein, aufgezeichnete Aktionen zu leugnen \cite{NIST13}.\todo{Wie zitiert man NIST?}
...
% Sicherheit in Senor Netzwerken CAS08
...
% CAS09: Redundancy, Diversity, principle of least privlege, separation of privilege

%Abschreckung: Deterrence
 % CAS09


% Überleitung: nicht verhinderbar -> reaktive
...
\section{Mitigation von Angriffszenarien durch Gegenmaßnahmen}\label{sec:diskussion}
